...
/*
 *
 * FILE : MPC5644A_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5644A derivative needed initializations, 
 *  and all initializations for the MPC5644A boards which are supported.
...
#include "MPC5644A.h"        /* MPC55xx platform development header            */
#include "MPC5644A_HWInit.h"
...
/*******************************************************/
/* MPC5644A derivative specific hardware initialization */
/*******************************************************/

/* Symbol L2SRAM_LOCATION is defined in the application linker command file (.lcf) 
   It is defined to the start of the L2SRAM of the MPC5644A. 
*/
...
/*******************************************************/
/* MPC5644A boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC5644ADEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC5644ADEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC5644A external bus
        Set up the pins
